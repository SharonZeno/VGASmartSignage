...
class Template1 : public uiApp {
  ...
  uiStaticLabel * fifthBulletlabel;
  ...
  void init() {
   ...
   // Main healine
    headlineLabel = new uiStaticLabel(rootWindow(), "Welcome To Our IOT Expo! ", Point(170, 30));
    ...
    // author label
    authorLabel = new uiStaticLabel(rootWindow(), "Expo Entrance", Point(70, 200));
    ...
    ScheduleFrame = new uiFrame(rootWindow(), "", Point(305, 60), Size(330, 250));
